...
class WorkerInstrumentationTest {
    ...
    private val mockUriInput =
        KEY_IMAGE_URI to "android.resource://tat.mukhutdinov.bluromatic/drawable/android_cupcake"
        ...
        runBlocking {
            ...
            assertTrue(
                resultUri?.startsWith(
                    "file:///data/user/0/tat.mukhutdinov.bluromatic/files/blur_filter_outputs/blur-filter-output-"
                ) ?: false
            )
        }
    }
